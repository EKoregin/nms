...
-- INSERT INTO customer (customer_name, address) values ('Ivanov', 'Pokrov');
-- INSERT INTO customer (customer_name, address) values ('Petrov', 'Kovrov');
-- INSERT INTO customer (customer_name, address) values ('Sidorov', 'Lakinsk');
